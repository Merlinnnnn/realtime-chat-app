...
import { Users, UsersRound } from "lucide-react"; // UsersRound cho nhóm
import React from "react";

const Sidebar = () => {
  const { getUsers, users, selectedUser, setSelectedUser, selectedGroup, setSelectedGroup, isUsersLoading, getGroups, groups, setNull } = useChatStore();
